...
public class MeanLogTable {
     ...
     */
    public MeanLogTable(long timestamp) {
        this(
                "/",
                0,
     ...
     */
    private MeanLogTable(String prefix, MeanLogTable parent) {
        this(
                prefix,
                parent.depth + 1,
                parent.timestamp,
     ...
     */
    public static MeanLogTable clone(MeanLogTable source) {
        Map<String, LogValue> data = new HashMap<String, LogValue>();
        data.putAll(source.data);
        return new MeanLogTable(
                source.prefix,
                source.depth,
     ...
     */
    public MeanLogTable getSubtable(String tableName) {
        return new MeanLogTable(prefix + tableName + "/", this);
    }
...
//    }
     ...
     * @return The field value.
     */
    public <T extends MeanLoggableInputs> T get(String key, T defaultValue) {

package org.team2471.frc.lib.motion.localization
...
import org.team2471.frc.lib.motion.control.LoopLogger
import org.team2471.frc.lib.motion.isSim
import org.team2471.frc.lib.motion.toTransform2d
import org.team2471.frc.lib.motion.vision.Fiducial
import org.team2471.frc.lib.motion.vision.PipelineVisionPacket
import org.team2471.frc.lib.motion.vision.QuixVisionCamera
import org.team2471.frc.lib.motion.vision.QuixVisionSim
...
//            println("vision measurement is too far in the past")
    ...
    fun update(odometryMeasurement: OdometryMeasurement, visionPackets: List<PipelineVisionPacket>, chassisSpeeds: ChassisSpeeds) {
        ...
        chassisSpeedsBuffer.addSample(odometryTimestamp, InterpolatableChassisSpeeds.Companion.fromChassisSpeeds(chassisSpeeds))

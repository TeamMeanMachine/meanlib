...
This document tracks the locations and statuses of all of our batteries.
The naming system consists of three parts. A category followed by a type and a number.
For example, a OV9281 camera could be labeled "CA03" (Camera of type A numbered 3).
...
|:---------:|:------:|:-------------------------:|:------------------------------------------------:|:---------------:|:--------:|
| CA01 (19) | OV9281 |       Typhoon (SL)        |     In use, needs calibration, focus, & name     |        ?        |    X     |
| CA02 (8)  | OV9281 |       Typhoon (SR)        |     In use, needs calibration, focus, & name     |        ?        |    X     |
| CA03 (15) | OV9281 |       Typhoon (IB)        |     In use, needs calibration, focus, & name     |        ?        |    X     |
| CC04 (C)  | OV9782 |     Typhoon (NoteCam)     |                In use, needs name                |       N/A       |    X     |
